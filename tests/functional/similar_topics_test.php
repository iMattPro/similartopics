...
class similar_topics_test extends similar_topics_base
{
	public function test_similar_topics()
	{
		...
		$topic1 = $this->create_topic(2, 'Test Topic 1', 'This is test topic 1 posted by the testing framework.');
		$topic2 = $this->create_topic(2, 'Test Topic 2', 'This is test topic 2 posted by the testing framework.');
		$topic3 = $this->create_topic(2, 'Test Topic 3', 'This is test topic 3 posted by the testing framework.');
		$topic4 = $this->create_topic(2, 'Test Framework Topic 4', 'This is test topic 4 posted by the testing framework.');
		$topic5 = $this->create_topic(2, 'Test Framework Topic 5', 'This is test topic 5 posted by the testing framework.');
