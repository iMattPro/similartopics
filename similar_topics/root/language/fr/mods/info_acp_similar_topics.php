...
$lang = array_merge($lang, array(
	...
	//For UMIL Installer
	'PST_FULLTEXT_ADD'	=> 'Ajout d’un index FULLTEXT: topic_title',
	'PST_FULLTEXT_DROP'	=> 'Suppression d’un index FULLTEXT index: topic_title',
	'PST_FULLTEXT_PASS'	=> 'Votre base de donées est compatible avec ce MOD. Profitez-en :-)',
	'PST_FULLTEXT_FAIL'	=> '<span class="error"><strong>Attention:</strong> Vous ne devriez pas installer ce mod! Votre base de données ne supporte pas les index FULLTEXT. Cela signifie généralement que votre table des sujets n’utilise pas le moteur de stockage MyISAM requis pour ce MOD. <a href="http://www.phpbb.com/customise/db/mod/precise_similar_topics_ii/faq/f_737" onclick="window.open(this.href);return false;">Plus d’informations</a>.</span>',
	'PST_DATABASE_FAIL'	=> '<span class="error"><strong>Attention:</strong> Vous ne devriez pas installer ce mod! Votre base de données n’est pas en MySQL comme requis par ce MOD.</span>',
));
