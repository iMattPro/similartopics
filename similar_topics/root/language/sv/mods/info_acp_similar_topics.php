...
$lang = array_merge($lang, array(
	...
	'PST_FULLTEXT_FAIL' => '<span class="error"><strong>VARNING:</strong> Du bör inte installera detta mod! Din databas stöder inte Fulltext index. Detta innebär vanligtvis din trådar bordet inte använder MyISAM lagring motorn som krävs för detta MOD ska fungera.</span>',
