...
$lang = array_merge($lang, array(
	...
	'PST_SETTINGS'		=> 'Vergleichbare Themen Einstellungen',
	...
	'PST_WARNING'		=> 'Vergleichbare Themen werden in diesem Forum nicht funktionieren. Vergleichbare Themen verwendet FULLTEXT-Indizes, die eine MySQL 4 oder MySQL 5 Datenbank und die phpbb_topics-Tabelle benötigen, müssen sich an die MyISAM-Speicher-Engine gesetzt werden (oder InnoDB ist auch erlaubt, wenn sie mit MySQL 5.6.4 oder neuer verwendet wird). <br /> <br /> Wenn Sie Vergleichbare Themen verwenden möchten, können wir sicher aktualisieren Sie Ihre Datenbank, um FULLTEXT-Indizes unterstützt. Alle vorgenommenen Änderungen werden rückgängig gemacht werden, wenn Sie jemals entscheiden Vergleichbare Themen zu entfernen.',
	...
	'PST_LOG_FULLTEXT'	=> '<strong>Veränderte Datenbank Vergleichbare Themen Kompatibilität</strong><br />» Changed “%s” Tabelle, um MyISAM-Engine und hat eine FULLTEXT-Index auf die “topic_title”',
