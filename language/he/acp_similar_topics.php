...
$lang = array_merge($lang, array(
	...
	'PST_SENSE_EXPLAIN'	=> 'הגדר את הרלוונטיות המינימלית לחיפושים לערך בין 1 ל־10. השתמש במספר נמוך יותר אם אינך רואה נושאים דומים. הגדרה מומלצת: <samp>%d</samp>',
	'PST_SENSE_UNAVAILABLE' => 'מסד הנתונים שלך אינו משתמש בהגדרה זו.',
	...
	'PST_JAVASCRIPT_REQUIRED' => 'JavaScript נדרש כדי לערוך את הגדרות הפורומים ואת בחירת המקורות בדף זה. יש להפעיל JavaScript לפני שינוי הגדרות אלה.',
	...
	'PST_CUSTOM_RULES' => 'הגדרות מקור מותאמות אישית',
