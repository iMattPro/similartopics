...
$lang = array_merge($lang, array(
	...
	'PST_SENSE_EXPLAIN'	=> 'حداقل میزان ارتباط نتایج جستجو را روی مقداری بین 1 تا 10 تنظیم کنید. اگر هیچ موضوع مشابهی نمی‌بینید، از عدد کمتری استفاده کنید. تنظیم پیشنهادی: %d',
	'PST_SENSE_UNAVAILABLE' => 'پایگاه داده شما از این تنظیم استفاده نمی‌کند.',
