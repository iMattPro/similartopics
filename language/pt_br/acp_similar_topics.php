...
$lang = array_merge($lang, array(
	...
	'PST_DYNAMIC_EXPLAIN'=> 'Mostrar tópicos semelhantes enquanto os usuários digitam no campo de título ao criar novos tópicos.',
	'PST_SENSE'			=> 'Sensibilidade de pesquisa',
	'PST_SENSE_EXPLAIN'	=> 'Defina a relevância mínima das pesquisas entre 1 e 10. Use um número menor se você não estiver vendo tópicos semelhantes. Configuração recomendada: %d',
	'PST_SENSE_UNAVAILABLE' => 'Seu banco de dados não usa esta configuração.',
	...
	'PST_NO_COMPAT'		=> 'Tópicos Semelhantes não irá funcionar com seu Fórum. Similar Topics requer uma Base de Dados MySQL 4 ou MySQL 5 ou PostgreSQL.',
