...
$lang = array_merge($lang, array(
	...
	'PST_SENSE_EXPLAIN'	=> 'عيّن الحد الأدنى لمدى صلة نتائج البحث بقيمة بين 1 و 10. استخدم رقمًا أقل إذا لم تظهر لك أي مواضيع مشابهة. الإعداد الموصى به: <samp>%d</samp>',
	'PST_SENSE_UNAVAILABLE' => 'قاعدة البيانات لديك لا تستخدم هذا الإعداد.',
	...
	'PST_JAVASCRIPT_REQUIRED' => 'يلزم تمكين JavaScript لتعديل إعدادات المنتديات واختيارات المصادر في هذه الصفحة. قم بتمكين JavaScript قبل تغيير هذه الإعدادات.',
	...
	'PST_CUSTOM_RULES' => 'إعدادات المصدر المخصصة',
