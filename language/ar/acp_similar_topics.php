...
$lang = array_merge($lang, array(
	...
	'PST_WORDS_EXPLAIN'	=> 'سيتم استبعاد الكلمات التي ستضيفها هنا عند البحث عن المواضيع المُتشابهة. ( ملاحظة : يتم استبعاد الكلمات التي تعتبر شائعة في لغتك بصورة افتراضية ). اعمل مسافة بين كل كلمة وأخرى. هذا الخيار غير دقيق لتطابق الكلمات.',
