...
$lang = array_merge($lang, array(
	...
	'PST_EXPLAIN'		=> 'Precise Similar Topics displays a list of similar (related) topics. Similar topics can be shown at the bottom of the current topic’s discussion thread and/or when a user is writing a title for a new post.',
	...
	'PST_TIME_EXPLAIN'	=> 'This option allows you to confine similar topics results to newer topics (and prevent reviving old threads). For example, if set to “30 days” the system will only show similar topics from within the last 30 days. The default is 1 year. Set it to 0 for no time limit.',
	'PST_YEARS'			=> 'Years',
	'PST_MONTHS'		=> 'Months',
	'PST_WEEKS'			=> 'Weeks',
	'PST_DAYS'			=> 'Days',
