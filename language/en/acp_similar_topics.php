...
$lang = array_merge($lang, array(
	...
	'PST_NO_MYSQL'		=> 'Similar Topics is not compatible with your forum. Similar Topics will only run on a MySQL 4, MySQL 5 or PostgreSQL database.',
	...
	'PST_NO_POSTGRES_INDEX'	=> 'Postgres index is not created yet, Please choose `Text search Configuration Profile` and then submit',
	'PST_LEGEND_POSTGRES'	=> 'PostgreSQL setting',
	'PST_POSTGRES_TS_NAME'	=> 'Text search Configuration Profile:',
	'PST_POSTGRES_TS_NAME_EXPLAIN'	=> 'The Text search configuration profile used to determine the parser and dictionary.',
));
