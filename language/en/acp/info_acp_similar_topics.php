...
$lang = array_merge($lang, array(
	...
	'PST_EXPLAIN'		=> 'Precise Similar Topics II displays a list of similar (related) topics at the bottom of the current topic’s page.',
	...
	'PST_ADVANCED_EXP'	=> 'Here you can select specific forums to pull similar topics from. Only similar topics found in the forums you select here will be displayed in <strong>%s</strong>.<br /><br />Do not select any forums if you want similar topics from all searchable forums to be displayed in this forum.<br /><br />Select/Deselect multiple forums by holding <samp>CTRL</samp> and clicking.',
