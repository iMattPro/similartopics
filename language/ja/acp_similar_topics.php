...
$lang = array_merge($lang, array(
	...
	'PST_SENSE'			=> '検索感度',
	'PST_SENSE_EXPLAIN'	=> '検索結果の最小関連度を 1 から 10 の間で設定します。類似トピックが表示されない場合は、低い値を使用してください。推奨設定: %d',
	'PST_SENSE_UNAVAILABLE' => '使用中のデータベースでは、この設定は使用されません。',
	'PST_WORDS'			=> '無視する単語',
	...
	'PST_JAVASCRIPT_REQUIRED' => 'このページでフォーラム設定とソースの選択を編集するには、JavaScript が必要です。これらの設定を変更する前に JavaScript を有効にしてください。',
