...
$lang = array_merge($lang, array(
	...
	'PST_SENSE_EXPLAIN'	=> 'Ställ in minsta relevans för sökningar på ett värde mellan 1 och 10. Använd ett lägre tal om inga liknande ämnen visas. Rekommenderad inställning: %d',
	'PST_SENSE_UNAVAILABLE' => 'Din databas använder inte den här inställningen.',
	...
	'PST_JAVASCRIPT_REQUIRED' => 'JavaScript krävs för att redigera foruminställningar och källval på den här sidan. Aktivera JavaScript innan du ändrar dessa inställningar.',
	...
	'PST_CUSTOM_RULES' => 'anpassade källinställningar',
